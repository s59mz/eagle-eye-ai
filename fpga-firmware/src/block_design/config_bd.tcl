...
proc create_hier_cell_capture_pipeline { parentCell nameHier } {
  ...
  set_property CONFIG.FIFO_DEPTH {1024} $axis_data_fifo_cap
  ...
  connect_bd_intf_net -intf_net [get_bd_intf_nets mipi_csi2_rx_subsyst_0_video_out] [get_bd_intf_pins axis_data_fifo_cap/S_AXIS] [get_bd_intf_pins video_out]
  ...
  connect_bd_net -net mipi_csi2_rx_subsyst_0_csirxss_csi_irq [get_bd_pins mipi_csi2_rx_subsyst_0/csirxss_csi_irq] [get_bd_pins csirxss_csi_irq]
  ...
  connect_bd_net -net v_frmbuf_wr_1_interrupt [get_bd_pins v_frmbuf_wr_0/interrupt] [get_bd_pins interrupt]
  connect_bd_net -net xlslice_2_Dout [get_bd_pins xlslice_0/Dout] [get_bd_pins v_frmbuf_wr_0/ap_rst_n]
...
proc create_root_design { parentCell } {
  ...
  set pmod1_uart [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:uart_rtl:1.0 pmod1_uart ]

  set pmod1_led [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 pmod1_led ]

  set pmod1_btn [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 pmod1_btn ]
  ...
  set pmod1_uart_rxn [ create_bd_port -dir O -from 0 -to 0 pmod1_uart_rxn ]

  # Create instance: PS_0, and set properties
  set PS_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:zynq_ultra_ps_e:3.5 PS_0 ]
  set_property -dict [list \
...
\
  ...
  set_property CONFIG.NUM_MI {1} $axi_ic_ctrl_300
  ...
  set_property CONFIG.NUM_PORTS {6} $xlconcat_0_0
  ...
  connect_bd_intf_net -intf_net axi_gpio_0_GPIO [get_bd_intf_ports pmod1_led] [get_bd_intf_pins axi_gpio_0/GPIO]
  connect_bd_intf_net -intf_net axi_gpio_0_GPIO2 [get_bd_intf_ports pmod1_btn] [get_bd_intf_pins axi_gpio_0/GPIO2]
  ...
  connect_bd_intf_net -intf_net axi_ic_ctrl_100_M03_AXI [get_bd_intf_pins axi_uartlite_0/S_AXI] [get_bd_intf_pins axi_ic_ctrl_100/M03_AXI]
  connect_bd_intf_net -intf_net axi_ic_ctrl_100_M04_AXI [get_bd_intf_pins axi_gpio_0/S_AXI] [get_bd_intf_pins axi_ic_ctrl_100/M04_AXI]
  ...
  connect_bd_intf_net -intf_net axi_uartlite_0_UART [get_bd_intf_ports pmod1_uart] [get_bd_intf_pins axi_uartlite_0/UART]
  connect_bd_intf_net -intf_net capture_pipeline_m_axi_mm_video [get_bd_intf_pins PS_0/S_AXI_HP0_FPD] [get_bd_intf_pins capture_pipeline/m_axi_mm_video]
  ...
  # Create port connections
  connect_bd_net -net ARESETN_1 [get_bd_pins proc_sys_reset_100MHz/interconnect_aresetn] [get_bd_pins axi_ic_ctrl_100/ARESETN]
  connect_bd_net -net PS_0_emio_gpio_o [get_bd_pins PS_0/emio_gpio_o] [get_bd_pins capture_pipeline/Din] [get_bd_pins vcu/Din] [get_bd_pins xlslice_0/Din]
  ...
  connect_bd_net -net axi_gpio_0_ip2intc_irpt [get_bd_pins axi_gpio_0/ip2intc_irpt] [get_bd_pins xlconcat_0_0/In5]
  connect_bd_net -net axi_iic_0_iic2intc_irpt [get_bd_pins axi_iic_0/iic2intc_irpt] [get_bd_pins xlconcat_0_0/In3]
  connect_bd_net -net axi_uartlite_0_interrupt [get_bd_pins axi_uartlite_0/interrupt] [get_bd_pins xlconcat_0_0/In4]
  connect_bd_net -net capture_pipeline_interrupt [get_bd_pins capture_pipeline/interrupt] [get_bd_pins xlconcat_0_0/In1]
  connect_bd_net -net clk_wiz_0_clk_100M [get_bd_pins clk_wiz_0/clk_100M] [get_bd_pins PS_0/maxihpm0_lpd_aclk] [get_bd_pins axi_ic_ctrl_100/ACLK] [get_bd_pins axi_ic_ctrl_100/M00_ACLK] [get_bd_pins axi_ic_ctrl_100/M01_ACLK] [get_bd_pins axi_ic_ctrl_100/M02_ACLK] [get_bd_pins axi_ic_ctrl_100/M03_ACLK] [get_bd_pins axi_ic_ctrl_100/M04_ACLK] [get_bd_pins axi_ic_ctrl_100/S00_ACLK] [get_bd_pins axi_iic_0/s_axi_aclk] [get_bd_pins capture_pipeline/lite_aclk] [get_bd_pins proc_sys_reset_100MHz/slowest_sync_clk] [get_bd_pins vcu/s_axi_lite_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_uartlite_0/s_axi_aclk]
  connect_bd_net -net clk_wiz_0_clk_200M [get_bd_pins clk_wiz_0/clk_200M] [get_bd_pins capture_pipeline/dphy_clk_200M]
  connect_bd_net -net clk_wiz_0_clk_300M [get_bd_pins clk_wiz_0/clk_300M] [get_bd_pins PS_0/maxihpm0_fpd_aclk] [get_bd_pins PS_0/maxihpm1_fpd_aclk] [get_bd_pins PS_0/saxi_lpd_aclk] [get_bd_pins PS_0/saxihp0_fpd_aclk] [get_bd_pins PS_0/saxihp1_fpd_aclk] [get_bd_pins PS_0/saxihp2_fpd_aclk] [get_bd_pins PS_0/saxihp3_fpd_aclk] [get_bd_pins PS_0/saxihpc0_fpd_aclk] [get_bd_pins PS_0/saxihpc1_fpd_aclk] [get_bd_pins axi_ic_accel_ctrl/ACLK] [get_bd_pins axi_ic_accel_ctrl/M00_ACLK] [get_bd_pins axi_ic_accel_ctrl/S00_ACLK] [get_bd_pins axi_ic_audio_mcu/ACLK] [get_bd_pins axi_ic_audio_mcu/M00_ACLK] [get_bd_pins axi_ic_audio_mcu/S00_ACLK] [get_bd_pins axi_ic_audio_mcu/S01_ACLK] [get_bd_pins axi_ic_audio_mcu/S02_ACLK] [get_bd_pins axi_ic_ctrl_300/ACLK] [get_bd_pins axi_ic_ctrl_300/M00_ACLK] [get_bd_pins axi_ic_ctrl_300/S00_ACLK] [get_bd_pins axi_vip_0/aclk] [get_bd_pins capture_pipeline/aclk] [get_bd_pins proc_sys_reset_300MHz/slowest_sync_clk] [get_bd_pins vcu/m_axi_dec_aclk]
  ...
  connect_bd_net -net proc_sys_reset_1_interconnect_aresetn [get_bd_pins proc_sys_reset_300MHz/interconnect_aresetn] [get_bd_pins axi_ic_accel_ctrl/ARESETN] [get_bd_pins axi_ic_audio_mcu/ARESETN] [get_bd_pins axi_ic_ctrl_300/ARESETN]
  connect_bd_net -net proc_sys_reset_1_peripheral_aresetn [get_bd_pins proc_sys_reset_300MHz/peripheral_aresetn] [get_bd_pins axi_ic_accel_ctrl/M00_ARESETN] [get_bd_pins axi_ic_accel_ctrl/S00_ARESETN] [get_bd_pins axi_ic_audio_mcu/M00_ARESETN] [get_bd_pins axi_ic_audio_mcu/S00_ARESETN] [get_bd_pins axi_ic_audio_mcu/S01_ARESETN] [get_bd_pins axi_ic_audio_mcu/S02_ARESETN] [get_bd_pins axi_ic_ctrl_300/M00_ARESETN] [get_bd_pins axi_ic_ctrl_300/S00_ARESETN] [get_bd_pins axi_vip_0/aresetn] [get_bd_pins capture_pipeline/aresetn] [get_bd_pins vcu/aresetn]
  connect_bd_net -net proc_sys_reset_2_peripheral_aresetn [get_bd_pins proc_sys_reset_100MHz/peripheral_aresetn] [get_bd_pins axi_ic_ctrl_100/M00_ARESETN] [get_bd_pins axi_ic_ctrl_100/M01_ARESETN] [get_bd_pins axi_ic_ctrl_100/M02_ARESETN] [get_bd_pins axi_ic_ctrl_100/M03_ARESETN] [get_bd_pins axi_ic_ctrl_100/M04_ARESETN] [get_bd_pins axi_ic_ctrl_100/S00_ARESETN] [get_bd_pins axi_iic_0/s_axi_aresetn] [get_bd_pins capture_pipeline/lite_aresetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_uartlite_0/s_axi_aresetn]
  connect_bd_net -net vcu_0_vcu_host_interrupt [get_bd_pins vcu/vcu_host_interrupt] [get_bd_pins xlconcat_0_0/In2]
  connect_bd_net -net xlconcat_0_0_dout [get_bd_pins xlconcat_0_0/dout] [get_bd_pins PS_0/pl_ps_irq1]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins xlconstant_0/dout] [get_bd_ports ap1302_standby]
  connect_bd_net -net xlconstant_1_dout [get_bd_pins xlconstant_1/dout] [get_bd_ports pmod1_uart_rxn]
  connect_bd_net -net xlslice_0_Dout [get_bd_pins xlslice_0/Dout] [get_bd_ports ap1302_rst_b]
  ...
  assign_bd_address -offset 0x80010000 -range 0x00010000 -target_address_space [get_bd_addr_spaces PS_0/Data] [get_bd_addr_segs axi_gpio_0/S_AXI/Reg] -force
  ...
  assign_bd_address -offset 0x80020000 -range 0x00010000 -target_address_space [get_bd_addr_spaces PS_0/Data] [get_bd_addr_segs axi_uartlite_0/S_AXI/Reg] -force
  ...
  assign_bd_address -offset 0x80000000 -range 0x00002000 -target_address_space [get_bd_addr_spaces PS_0/Data] [get_bd_addr_segs capture_pipeline/mipi_csi2_rx_subsyst_0/csirxss_s_axi/Reg] -force
  assign_bd_address -offset 0xB0010000 -range 0x00010000 -target_address_space [get_bd_addr_spaces PS_0/Data] [get_bd_addr_segs capture_pipeline/v_frmbuf_wr_0/s_axi_CTRL/Reg] -force
  ...
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces capture_pipeline/v_frmbuf_wr_0/Data_m_axi_mm_video] [get_bd_addr_segs PS_0/SAXIGP2/HP0_DDR_LOW] -force
